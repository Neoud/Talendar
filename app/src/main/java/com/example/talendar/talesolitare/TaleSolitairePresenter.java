...
public class TaleSolitairePresenter implements TaleSolitaireContract.Presenter{
    private TaleSolitaireContract.View mView;
    private TaleSolitaireDataSource mTSDataSource;
    private UserDataSource mUserDataSource;

    public TaleSolitairePresenter(TaleSolitaireContract.View view, TaleSolitaireDataSource taleSolitaireDataSource, UserDataSource userDataSource) {
        mView = view;
    ...
    @Override
    public void initTaleSolitaireShow(int tag) {
